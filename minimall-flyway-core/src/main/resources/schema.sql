-- H2 兼容 schema，由 V1__init_minimall.sql 派生，用于 test profile。Spring Boot 在 spring.sql.init.mode=always 时自动加载
-- ============================================================
-- 薄荷商城（mini_mail_system）统一数据库初始化脚本（H2 兼容版）
-- 由 V1__init_minimall.sql 派生：删除 ENGINE/CHARSET/COLLATE/SET NAMES/SET FOREIGN_KEY_CHECKS
-- 表/字段/索引/约束/列定义/类型/注释与 V1__init_minimall.sql 保持一致
-- ============================================================
